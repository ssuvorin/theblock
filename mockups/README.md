...
Then open <http://localhost:8081/mockups/Second%20Brain%20Mockups.dc.html>.

Port 8080 is reserved for the self-hosted Evolution API; the frontend dev server uses
3000 and the backend 8000.
